...
(function(root, factory) {
  ...
  describe('QuestionsApi', function() {
    ...
    describe('getQuestionResourceTasksTaskIdQuestionsQuestionIdResourceGet', function() {
      it('should call getQuestionResourceTasksTaskIdQuestionsQuestionIdResourceGet successfully', function(done) {
        //uncomment below and update the code to test getQuestionResourceTasksTaskIdQuestionsQuestionIdResourceGet
        //instance.getQuestionResourceTasksTaskIdQuestionsQuestionIdResourceGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
