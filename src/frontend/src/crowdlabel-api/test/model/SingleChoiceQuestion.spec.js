...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrowdLabelApi.SingleChoiceQuestion();
  });
  ...
  describe('SingleChoiceQuestion', function() {
    it('should create an instance of SingleChoiceQuestion', function() {
      // uncomment below and update the code to test SingleChoiceQuestion
      //var instance = new CrowdLabelApi.SingleChoiceQuestion();
      //expect(instance).to.be.a(CrowdLabelApi.SingleChoiceQuestion);
    });
