...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrowdLabelApi.RegistrationRequest();
  });
  ...
  describe('RegistrationRequest', function() {
    it('should create an instance of RegistrationRequest', function() {
      ...
      //var instance = new CrowdLabelApi.RegistrationRequest();
      //expect(instance).to.be.a(CrowdLabelApi.RegistrationRequest);
    });
