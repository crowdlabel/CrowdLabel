...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrowdLabelApi.HTTPValidationError();
  });
  ...
  describe('HTTPValidationError', function() {
    it('should create an instance of HTTPValidationError', function() {
      ...
      //var instance = new CrowdLabelApi.HTTPValidationError();
      //expect(instance).to.be.a(CrowdLabelApi.HTTPValidationError);
    });
