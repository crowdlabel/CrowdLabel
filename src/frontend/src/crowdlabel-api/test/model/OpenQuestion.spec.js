...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrowdLabelApi.OpenQuestion();
  });
  ...
  describe('OpenQuestion', function() {
    it('should create an instance of OpenQuestion', function() {
      // uncomment below and update the code to test OpenQuestion
      //var instance = new CrowdLabelApi.OpenQuestion();
      //expect(instance).to.be.a(CrowdLabelApi.OpenQuestion);
    });
