...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrowdLabelApi.Respondent();
  });
  ...
  describe('Respondent', function() {
    it('should create an instance of Respondent', function() {
      // uncomment below and update the code to test Respondent
      //var instance = new CrowdLabelApi.Respondent();
      //expect(instance).to.be.a(CrowdLabelApi.Respondent);
    });
