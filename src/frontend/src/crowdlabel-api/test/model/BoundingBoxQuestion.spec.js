...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrowdLabelApi.BoundingBoxQuestion();
  });
  ...
  describe('BoundingBoxQuestion', function() {
    it('should create an instance of BoundingBoxQuestion', function() {
      // uncomment below and update the code to test BoundingBoxQuestion
      //var instance = new CrowdLabelApi.BoundingBoxQuestion();
      //expect(instance).to.be.a(CrowdLabelApi.BoundingBoxQuestion);
    });
