...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrowdLabelApi.Corners();
  });
  ...
  describe('Corners', function() {
    it('should create an instance of Corners', function() {
      // uncomment below and update the code to test Corners
      //var instance = new CrowdLabelApi.Corners();
      //expect(instance).to.be.a(CrowdLabelApi.Corners);
    });
