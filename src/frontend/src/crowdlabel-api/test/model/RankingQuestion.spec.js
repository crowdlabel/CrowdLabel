...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrowdLabelApi.RankingQuestion();
  });
  ...
  describe('RankingQuestion', function() {
    it('should create an instance of RankingQuestion', function() {
      // uncomment below and update the code to test RankingQuestion
      //var instance = new CrowdLabelApi.RankingQuestion();
      //expect(instance).to.be.a(CrowdLabelApi.RankingQuestion);
    });
