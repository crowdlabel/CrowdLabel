...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrowdLabelApi.EditPasswordRequest();
  });
  ...
  describe('EditPasswordRequest', function() {
    it('should create an instance of EditPasswordRequest', function() {
      // uncomment below and update the code to test EditPasswordRequest
      //var instance = new CrowdLabelApi.EditPasswordRequest();
      //expect(instance).to.be.a(CrowdLabelApi.EditPasswordRequest);
    });
