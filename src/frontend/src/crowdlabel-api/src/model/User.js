...
class User {
     ...
     */
    constructor(userType, email, username, dateCreated) { 
        
        User.initialize(this, userType, email, username, dateCreated);
    }
     ...
     */
    static initialize(obj, userType, email, username, dateCreated) { 
...
User.RequiredProperties = ["user_type", "email", "username", "date_created"];
