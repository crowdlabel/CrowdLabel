 ...
 * @module model/SingleChoiceQuestion
 * @version 0.1.0
 */
class SingleChoiceQuestion {
    /**
     * Constructs a new <code>SingleChoiceQuestion</code>.
     * @alias module:model/SingleChoiceQuestion
    ...
    constructor(questionId, prompt, options) { 
        ...
        SingleChoiceQuestion.initialize(this, questionId, prompt, options);
    }
    ...
    /**
     * Constructs a <code>SingleChoiceQuestion</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SingleChoiceQuestion} obj Optional instance to populate.
     * @return {module:model/SingleChoiceQuestion} The populated <code>SingleChoiceQuestion</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SingleChoiceQuestion();
    ...
    /**
     * Validates the JSON data with respect to <code>SingleChoiceQuestion</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SingleChoiceQuestion</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SingleChoiceQuestion.RequiredProperties) {
            if (!data[property]) {
...
SingleChoiceQuestion.RequiredProperties = ["question_id", "prompt", "options"];

/**
 * @member {Number} question_id
 */
SingleChoiceQuestion.prototype['question_id'] = undefined;

/**
 * @member {String} question_type
 * @default 'single_choice'
 */
SingleChoiceQuestion.prototype['question_type'] = 'single_choice';

/**
 * @member {String} prompt
 */
SingleChoiceQuestion.prototype['prompt'] = undefined;
 ...
 */
SingleChoiceQuestion.prototype['options'] = undefined;
