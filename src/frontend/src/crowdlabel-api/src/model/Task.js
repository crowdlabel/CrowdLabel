...
class Task {
     ...
     */
    constructor(taskId, creator, dateCreated) { 
        
        Task.initialize(this, taskId, creator, dateCreated);
    }
     ...
     */
    static initialize(obj, taskId, creator, dateCreated) { 
        obj['task_id'] = taskId;
        obj['creator'] = creator;
...
Task.RequiredProperties = ["task_id", "creator", "date_created"];

/**
 * @member {String} name
 * @default 'My Task'
 */
Task.prototype['name'] = 'My Task';
