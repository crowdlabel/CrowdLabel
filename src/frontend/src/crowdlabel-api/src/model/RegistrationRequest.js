...
class RegistrationRequest {
     ...
     */
    constructor(username, email, password, userType, verificationCode) { 
        
        RegistrationRequest.initialize(this, username, email, password, userType, verificationCode);
    }
     ...
     */
    static initialize(obj, username, email, password, userType, verificationCode) { 
...
RegistrationRequest.RequiredProperties = ["username", "email", "password", "user_type", "verification_code"];
