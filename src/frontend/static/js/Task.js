...
class Task {
     ...
     * @param name {String} 
     * @param responsesRequired {Number} 
     */
    constructor(taskId, creator, dateCreated, credits, name, responsesRequired) { 
        
        Task.initialize(this, taskId, creator, dateCreated, credits, name, responsesRequired);
    }
     ...
     */
    static initialize(obj, taskId, creator, dateCreated, credits, name, responsesRequired) { 
        obj['task_id'] = taskId;
        obj['creator'] = creator;
        obj['date_created'] = dateCreated;
        obj['credits'] = credits;
        obj['name'] = name;
        obj['responses_required'] = responsesRequired;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['questions']) { // data not null
            ...
            for (const item of data['questions']) {
                Question.validateJsonObject(item);
            };
        }
...
Task.RequiredProperties = ["task_id", "creator", "date_created", "credits", "name", "responses_required"];
 ...
 */
Task.prototype['creator'] = undefined;
 ...
 */
Task.prototype['credits'] = undefined;
 ...
 * @member {String} cover
 */
Task.prototype['cover'] = undefined;
 ...
 */
Task.prototype['responses_required'] = undefined;
