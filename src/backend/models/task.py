...
class Task(Base):
    ...
    requester = relationship('Requester',secondary='requester2task',cascade="delete, delete-orphan",single_parent = True, overlaps="task_requested") # added overlaps
    respondent_claimed = relationship('Respondent',secondary='respondent2claim',cascade="delete, delete-orphan",single_parent = True, overlaps="task_complete") # added overlaps
    respondent_complete = relationship('Respondent',secondary = 'respondent2complete',cascade="delete, delete-orphan",single_parent = True, overlaps="task_complete") # added overlaps
